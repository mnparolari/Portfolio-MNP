	...
	return (
		<div style={{backgroundColor: "#000", display: "flex", alignItems: "center", justifyContent: "center"}}>
			<ReactCardFlip isFlipped={isFlipped} flipDirection="horizontal">
				<div onClick={handleClick} style={{ width: "490px", borderRadius: "1%", backgroundColor: "#000", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center"}}>
				...
				<div style={{ backgroundColor: "#000", display: "flex", alignItems: "center", justifyContent: "center" }} >
					<div style={{ display: "flex", justifyContent: "center", backgroundColor: "#000" }}>
						<div className="card mb-3" style={{ width: "450px", height: "390px", borderRadius: "1%", backgroundColor: "#000", marginRight: "15px", border: "1px solid " }}>
					...
					<div className="card" style={{ width: "490px", borderRadius: "1%", backgroundColor: "#000", display: "flex", alignItems: "center", flexDirection: "column" }}>
